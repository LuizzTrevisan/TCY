...
uses
  ...
  FMX.TMSWebGMapsPolylines, UITypes;
...
type
  ...
  published
    ...
    property BackgroundColor : TAlphaColor read FBackgroundColor write SetBackgroundColor default TAlphaColorRec.Blue;
    property BackgroundOpacity : integer read FBackgroundOpacity write SetBackgroundOpacity default 100;
    property BorderColor : TAlphaColor read FBorderColor write SetBorderColor default TAlphaColorRec.Blue;
...
begin
  ...
  FBackgroundColor      := TAlphaColorRec.Blue;
  FBackgroundOpacity    := 100;
  FBorderColor          := TAlphaColorRec.Blue;
  FBorderOpacity        := 255;
  FBorderWidth          := 4;
  FVisible              := True;
...
begin
  Result := Add(True, False, False, Path, TAlphaColorRec.Blue, TAlphaColorRec.Blue, 100, 255, 1, True, 0);
end;
...
constructor TPolygons.Create(AWebGMaps : TTMSFMXWebGMapsWebBrowser);
begin
