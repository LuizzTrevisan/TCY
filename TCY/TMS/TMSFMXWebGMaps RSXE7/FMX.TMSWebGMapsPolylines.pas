...
uses
  SysUtils, Classes, UITypes, FMX.TMSWebGMapsCommon, StrUtils,
  FMX.TMSWebGMapsConst, FMX.TMSWebGMapsCommonFunctions, FMX.TMSWebGMapsWebBrowser;
...
type
  ...
  published
    ...
    property Color : TAlphaColor read FColor write SetColor default TAlphaColorRec.Blue;
...
begin
  Result := Add(True, False, False, nil, Path, TAlphaColorRec.Blue, 100, 1, True, 0);
end;
...
constructor TPolylines.Create(AWebGMaps : TTMSFMXWebGMapsWebBrowser);
begin
...
procedure TPolylines.Notify(Item: TCollectionItem;
...
procedure TPath.Notify(Item: TCollectionItem; Action: TCollectionNotification);
begin
  inherited;
end;
...
begin
  inherited;
  FPolyline            := TSymbol(Collection).FPolyline;
...
procedure TSymbols.Notify(Item: TCollectionItem;
  Action: TCollectionNotification);
begin
  inherited;
end;
